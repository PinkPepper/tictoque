 ...
 */
class Version20170428115353 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE commande (id VARCHAR(255) NOT NULL, user INT DEFAULT NULL, date DATETIME NOT NULL, prix DOUBLE PRECISION DEFAULT NULL, INDEX IDX_6EEAA67D8D93D649 (user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commande_menu (id INT AUTO_INCREMENT NOT NULL, commande VARCHAR(255) DEFAULT NULL, menus INT DEFAULT NULL, INDEX IDX_16693B706EEAA67D (commande), INDEX IDX_16693B70727508CF (menus), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commande_produit (id INT AUTO_INCREMENT NOT NULL, commande VARCHAR(255) DEFAULT NULL, produits INT DEFAULT NULL, quantiteCommandee VARCHAR(255) NOT NULL, INDEX IDX_DF1E9E876EEAA67D (commande), INDEX IDX_DF1E9E87BE2DDF8C (produits), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
