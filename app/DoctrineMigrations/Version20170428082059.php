 ...
 */
class Version20170428082059 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT NOT NULL, user INT DEFAULT NULL, date DATETIME NOT NULL, prix DOUBLE PRECISION DEFAULT NULL, INDEX IDX_6EEAA67D8D93D649 (user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
